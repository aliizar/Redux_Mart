  ...
  return (
    <>
      <div className="p-4 sm:ml-64">
        <div className='text-white text-3xl font-serif ml-6 mb-3'> <p>Buy <span className='text-yellow-300'>Home Appliances</span> From Here:</p></div>
        <div className="p-4 border-2 grid grid-cols-3 space-x-2  border-gray-200 border-dashed rounded-lg dark:border-gray-700">

        {MyApiData.HomeAppliances.map((item) => {
            return (
